...
function model(sequelize) {
  const attributes = {
    ...
    genesisCommon: { type: DataTypes.FLOAT, allowNull: true, defaultValue: 0 },
    genesisUncommon: { type: DataTypes.FLOAT, allowNull: true, defaultValue: 0 },
    genesisRare: { type: DataTypes.FLOAT, allowNull: true, defaultValue: 0 },
    genesisEpic: { type: DataTypes.FLOAT, allowNull: true, defaultValue: 0 },
    ogCommon: { type: DataTypes.FLOAT, allowNull: true, defaultValue: 0 },
    ogUncommon: { type: DataTypes.FLOAT, allowNull: true, defaultValue: 0 },
    ogRare: { type: DataTypes.FLOAT, allowNull: true, defaultValue: 0 },
    ogEpic: { type: DataTypes.FLOAT, allowNull: true, defaultValue: 0 },
