...
function model(sequelize) {
  const attributes = {
    ...
    socket1: { type: DataTypes.CHAR, allowNull: false },
    socket2: { type: DataTypes.CHAR, allowNull: false },
    socket3: { type: DataTypes.CHAR, allowNull: false },
    socket4: { type: DataTypes.CHAR, allowNull: false },
    // Base
