...
export default function ConnectionModal({
  ...
  const config = {
    clientId: "1020677504324878337",
    clientSecret: "YopZM2fWhjt07xW3Kth3bRc5-U2HrMbm",
  ...
  const [request, response, discordConnection] = useAuthRequest(
    config,
    discovery
  );
  ...
  return (
    <Modal
      animationType="slide"
      transparent={true}
      visible={modalConnectionVisible}
    >
      <TouchableOpacity
        style={{
          flex: 1,
        ...
        activeOpacity={1}
        onPressOut={() => setModaConnectionVisible(false)}
      >
        <View
          style={{
