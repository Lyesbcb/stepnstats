      ...
      >
        ...
        >
          ...
          >
            <Pressable
              style={
                strategy === "GST" ? styles.strategyActive : styles.strategy
              }
              onPress={() => setStrategy("GST")}
            >
              <Text style={{ fontWeight: "800", fontSize: RFValue(20, 800) }}>GST</Text>
            </Pressable>
            <Pressable
              style={
                strategy === "MYSTERY BOX"
                  ? styles.strategyActive
                  : styles.strategy
              }
              onPress={() => setStrategy("MYSTERY BOX")}
            >
            ...
            <Pressable
              style={
                strategy === "HYBRID" ? styles.strategyActive : styles.strategy
              }
              onPress={() => setStrategy("HYBRID")}
            >
              <Text style={{ fontWeight: "800", fontSize: RFValue(20, 800) }}>HYBRID</Text>
            </Pressable>
          </View>
        </View>
